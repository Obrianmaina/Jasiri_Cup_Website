...
export const BlogSearchClient = ({ posts, error }: BlogSearchClientProps) => {
  ...
  // Hide the search bar entirely if there are no posts to search through
        ...
        {filteredPosts.length > 0 ? (
          ...
          !error && (
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
              {searchQuery ? (
                // State 1: The user searched for something that doesn't exist
                <>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 max-w-md transition-colors">
                    We couldn&apos;t find any articles matching &quot;{searchQuery}&quot;. Try adjusting your keywords to find what you are looking for.
                  </p>
                </>
              ) : (
                // State 2: There are just no additional articles to display yet
                <>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 max-w-md transition-colors">
                    There are no more articles to display right now. Enjoy the featured read above, and check back later for fresh stories.
                  </p>
                </>
              )}
            </div>
