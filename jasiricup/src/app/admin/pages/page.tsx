...
const DEFAULT_PRESS = {
  coverage: [] as PressCoverage[],
  downloads: [] as PressDownload[],
};
...
function HomeEditor({
  ...
  const addStat = () => {
    ...
    onChange({
      ...
      stats: {
        ...currentStats,
        numbers: [...numbers, { label: "New Stat", value: "0" }],
      },
    });
  };
    ...
    <div className="space-y-6">
      <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              type="text"
              value={data.about.imageSrc}
              onChange={(e) =>
                onChange({
                  ...data,
                  about: { ...data.about, imageSrc: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
            />
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs mb-1">Vision Title</label>
            <input
              type="text"
              ...
              onChange={(e) =>
                onChange({
                  ...data,
                  vision: { ...data.vision, title: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800 mb-2"
            />
            <label className="block text-xs mb-1">Vision Content</label>
            <textarea
              rows={3}
              ...
              onChange={(e) =>
                onChange({
                  ...data,
                  vision: { ...data.vision, content: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
            />
          ...
          <div>
            <label className="block text-xs mb-1">Mission Title</label>
            <input
              type="text"
              ...
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800 mb-2"
            />
            <label className="block text-xs mb-1">Mission Content</label>
            <textarea
              rows={3}
              ...
              onChange={(e) =>
                onChange({
                  ...data,
                  mission: { ...data.mission, content: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
            />
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-4 mb-6">
          <div>
            <label className="block text-xs mb-1">CTA Title</label>
            <input
              type="text"
              value={safeStats.title}
              onChange={(e) =>
                onChange({
                  ...data,
                  stats: { ...safeStats, title: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
            />
          ...
          <div>
            <label className="block text-xs mb-1">CTA Description</label>
            <textarea
              rows={2}
              value={safeStats.description}
              onChange={(e) =>
                onChange({
                  ...data,
                  stats: { ...safeStats, description: e.target.value },
                })
              }
              className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
            />
        ...
        <div className="border-t pt-4">
          <div className="flex justify-between items-center mb-3">
            ...
            <button
              type="button"
              onClick={addStat}
              className="text-xs text-purple-600 bg-purple-50 px-3 py-1.5 rounded"
            >
              + Add Stat
            </button>
          </div>
          {safeNumbers.map((stat, i) => (
            <div
              key={i}
              className="flex gap-3 mb-2 items-start bg-white dark:bg-gray-900 p-3 rounded-lg border"
            >
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full border rounded px-2 py-1.5 text-sm dark:bg-gray-800"
                />
              </div>
              <div className="flex-1">
                <label className="block text-[10px] uppercase mb-1">
              ...
              <button
                ...
                className="text-red-500 bg-red-50 px-3 py-1.5 rounded text-xs mt-5"
              >
                Remove
              </button>
            </div>
...
function TeamEditor({
  ...
  const updateMember = <K extends keyof TeamMember>(
    id: string,
    field: K,
    value: TeamMember[K],
  ) => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateMember(member.id, "imageSrc", e.target.value)
                }
                className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
              />
            </div>
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  updateMember(member.id, "cardColor", e.target.value)
                }
                className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800"
              >
      ...
      <button
        onClick={addMember}
        className="w-full py-2.5 border-2 border-dashed border-purple-300 text-purple-600 rounded-xl text-sm font-medium"
      >
        + Add Team Member
      </button>
    </div>
...
function ProductEditor({
  ...
  data: ProductContent;
  onChange: (d: ProductContent) => void;
}) {
  const updateStep = (
    id: number,
    field: keyof ProductStep,
    value: string | number,
  ) => {
    onChange({
      ...data,
      ...
      <div>
        ...
        <div className="space-y-3">
          {data.steps.map((step) => (
            <div
              key={step.id}
              className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border space-y-2"
            >
              ...
              <input
                ...
                value={step.videoUrl}
                onChange={(e) =>
                  updateStep(step.id, "videoUrl", e.target.value)
                }
...
function GenericArrayEditor<T extends object>({ 
  ...
  onChange: (d: T[]) => void; 
  defaultItem: T; 
  fields: { key: keyof T; label: string; type: 'text' | 'textarea' | 'number' | 'array' }[]; 
  title: string; 
}) {
  // Use T[keyof T] to strictly bind the value to the specific key being updated
  const updateItem = (index: number, key: keyof T, val: T[keyof T]) => { 
    const copy = [...data]; 
    copy[index] = { ...copy[index], [key]: val }; 
    onChange(copy); 
  };
  
  // Safely cast the new item to T
  ...
  return (
    <div className="space-y-6">
            ...
            {fields.map(f => (
              <div key={String(f.key)} className={f.type === 'textarea' || f.type === 'array' ? 'sm:col-span-2' : ''}>
                ...
                {f.type === 'textarea' ? (
                  ...
                  <input 
                    value={(item[f.key] as unknown as string[]).join(', ')} 
                    onChange={e => updateItem(i, f.key, e.target.value.split(',').map(s => s.trim()) as unknown as T[keyof T])} 
                  ...
                  <input 
                    type={f.type} 
                    value={item[f.key] as unknown as string} 
                    onChange={e => updateItem(i, f.key, (f.type === 'number' ? Number(e.target.value) : e.target.value) as unknown as T[keyof T])} 
                    className="w-full border rounded-lg px-3 py-2 text-sm dark:bg-gray-800" 
                  />
                )}
              </div>
      ...
      <button onClick={addItem} className="w-full py-2.5 border-2 border-dashed border-purple-300 text-purple-600 rounded-xl text-sm font-medium">
        + Add {title}
      </button>
    </div>
  );
...
export default function AdminPagesPage() {
  const [activeTab, setActiveTab] = useState<
    "home" | "team" | "product" | "stories" | "press" | "partners" | "volunteer"
  >("home");
  ...
  const [productContent, setProductContent] =
    useState<ProductContent>(DEFAULT_PRODUCT);
  ...
  const [volunteerRoles, setVolunteerRoles] =
    useState<VolunteerRole[]>(DEFAULT_VOLUNTEER);
  ...
  try {
    const [homeRes, teamRes, productRes, storiesRes, pressRes, partRes, volRes] = await Promise.all([
      fetch('/api/admin/site-content?page=home'), fetch('/api/admin/site-content?page=team'), fetch('/api/admin/site-content?page=product'),
      fetch('/api/admin/site-content?page=stories'), fetch('/api/admin/site-content?page=press'), fetch('/api/admin/site-content?page=partners'), fetch('/api/admin/site-content?page=volunteer')
    ]);
    
    if (homeRes.ok) { 
      const { data } = await homeRes.json(); 
      const m = data.find((d: SectionData<HomeContent>) => d.section === 'main'); 
      if (m?.content) setHomeContent(m.content); 
    }
    
    if (teamRes.ok) { 
      const { data } = await teamRes.json(); 
      const m = data.find((d: SectionData<{ members: TeamMember[] }>) => d.section === 'members'); 
      if (m?.content?.members) setTeamMembers(m.content.members); 
    }
    
    if (productRes.ok) { 
      const { data } = await productRes.json(); 
      const m = data.find((d: SectionData<ProductContent>) => d.section === 'main'); 
      if (m?.content) setProductContent(m.content); 
    }
    
    if (storiesRes.ok) { 
      const { data } = await storiesRes.json(); 
      const m = data.find((d: SectionData<{ stories: Story[] }>) => d.section === 'main'); 
      if (m?.content?.stories) setStories(m.content.stories); 
    }
    
    if (pressRes.ok) { 
      const { data } = await pressRes.json(); 
      const m = data.find((d: SectionData<{ coverage: PressCoverage[], downloads: PressDownload[] }>) => d.section === 'main'); 
      if (m?.content) setPressContent(m.content); 
    }
    
    if (partRes.ok) { 
      const { data } = await partRes.json(); 
      const m = data.find((d: SectionData<{ partners: Partner[] }>) => d.section === 'main'); 
      if (m?.content?.partners) setPartners(m.content.partners); 
    }
    
    if (volRes.ok) { 
      const { data } = await volRes.json(); 
      const m = data.find((d: SectionData<{ roles: VolunteerRole[] }>) => d.section === 'main'); 
      if (m?.content?.roles) setVolunteerRoles(m.content.roles); 
    }
  } catch (err) { 
  ...
  const handleSave = async () => {
    ...
    try {
      let payload;
      if (activeTab === "home")
        payload = { page: "home", section: "main", content: homeContent };
      else if (activeTab === "team")
        payload = {
          page: "team",
          section: "members",
          content: { members: teamMembers },
        };
      else if (activeTab === "product")
        payload = { page: "product", section: "main", content: productContent };
      else if (activeTab === "stories")
        payload = { page: "stories", section: "main", content: { stories } };
      else if (activeTab === "press")
        payload = { page: "press", section: "main", content: pressContent };
      else if (activeTab === "partners")
        payload = { page: "partners", section: "main", content: { partners } };
      else if (activeTab === "volunteer")
        payload = {
          page: "volunteer",
          section: "main",
          content: { roles: volunteerRoles },
        };
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 border-b pb-4">
        <div>
          <Link
            ...
            className="inline-flex items-center text-sm font-medium text-purple-600 mb-4"
          >
        ...
        <button
          ...
          className="px-5 py-2.5 bg-purple-600 text-white rounded-xl font-medium shadow-sm hover:bg-purple-700 disabled:opacity-50"
        >
      ...
      <div className="flex gap-2 border-b overflow-x-auto">
        {TABS.map((tab) => (
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium rounded-t-lg whitespace-nowrap border-b-2 ${activeTab === tab.id ? "border-purple-600 text-purple-700 bg-purple-50" : "border-transparent text-gray-600"}`}
          >
            {tab.label}
          </button>
        ))}
        ...
        {loading ? (
          ...
          <GenericArrayEditor
            ...
            fields={[
              ...
              { key: "impact", label: "Impact Badges", type: "array" },
            ]}
          />
        ) : activeTab === "partners" ? (
          <GenericArrayEditor
            ...
            fields={[
              ...
              { key: "county", label: "County/Region", type: "text" },
              { key: "girls", label: "Girls Supported", type: "number" },
              { key: "type", label: "Type (School, NGO, etc)", type: "text" },
          ...
          <div className="space-y-8">
            <div>
              ...
              <GenericArrayEditor
                data={pressContent.coverage}
                onChange={(c) =>
                  setPressContent({ ...pressContent, coverage: c })
                }
                title="Article"
                defaultItem={{
                  outlet: "",
                ...
                fields={[
                  ...
                  { key: "logo", label: "Emoji Logo", type: "text" },
                ]}
              />
            </div>
            <div>
              ...
              <GenericArrayEditor
                data={pressContent.downloads}
                onChange={(d) =>
                  setPressContent({ ...pressContent, downloads: d })
                }
                title="Asset"
                ...
                fields={[
                  ...
                  { key: "icon", label: "Emoji Icon", type: "text" },
                  { key: "file", label: "Download URL", type: "text" },
                ]}
              />
            </div>
          </div>
